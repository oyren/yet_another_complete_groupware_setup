...
[source,bash]
----
mkdir -p /root/docker/web/welcome_page
mkdir -p /root/docker/openvpn
git clone https://github.com/mailcow/mailcow-dockerized.git /root/docker/mailcow-dockerized
wget https://raw.githubusercontent.com/oyren/knowledge/master/server_setup/web/docker-compose.yml -P /root/docker/web
----
